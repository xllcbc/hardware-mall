...
CREATE TABLE IF NOT EXISTS `shop_order` (
    ...
    `logistics_id` BIGINT UNSIGNED DEFAULT NULL COMMENT '物流方式ID(自提为空)',
    `delivery_type` TINYINT DEFAULT NULL COMMENT '发货方式：2-同城配送，4-用户自提',
    `wechat_order_state` TINYINT DEFAULT NULL COMMENT '微信订单状态(展示/对账)：1待发货 2已发货 3确认收货 4交易完成 5已退款 6资金待结算',
